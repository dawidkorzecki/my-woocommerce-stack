 ...
 $license_data->license = 'valid';
        ...
        <form method="post" class="form-inline">
            ...
            <div class="form-group beta-updates" style="margin-bottom: 30px;">
                <input type="checkbox"  id="<?php echo $this->data['license_beta']; ?>" name="<?php echo $this->data['license_beta']; ?>" value="1" <?php if ( $beta == '1' ) echo 'checked="checked"'; ?> />
